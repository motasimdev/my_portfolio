          ...
          <Container>
            <div className="">
              ...
              <div className="px-3 lg:px-0">
                {/* =========project 1======== */}
                <div className="p-1.5 md:p-3 border border-white/20 bg-white/15 backdrop-blur-[15px] md:flex justify-between shadow-[6px_11px_17px_0px_rgba(0,_0,_0,_0.2)]">
                  ...
                  <div className="md:w-[52%] px-2 lg:px-0">
                    <h4 className="text-xl md:text-2xl lg:text-3xl font-medium md:font-semibold text-[#E0FFFE] text-center md:text-left py-0 md:py-5">
                      Project Brief
                    </h4>
                    <p className="text-white text-[13px] lg:text-base text-justify leading-6 md:leading-[32px]">
