  ...
  return (
    <>
      ...
      >
        <Container>
          <div className="">
            <div className="bg-[radial-gradient(circle,rgba(11,86,99,1)_0%,rgba(23,102,114,1)_0%,rgba(31,113,124,1)_25%,rgba(38,122,132,1)_38%,rgba(43,128,138,1)_53%,rgba(48,134,144,1)_66%,rgba(52,139,149,1)_79%,rgba(59,147,157,1)_100%)] text-center py-3 lg:py-6 mb-10 lg:mb-25">
            ...
            <Marquee speed={50} gradient={false}>
              <Flex className={"flex-wrap gap-x-0 md:gap-x-14 lg:gap-x-10 justify-between"}>
                ...
                <div className="bg-primary flex justify-center items-center h-8 lg:h-12.5 w-[110px] lg:w-[160px] gap-x-4 cursor-pointer">
                ...
                <div className="bg-primary flex justify-center items-center h-9 lg:h-12.5 w-[110px] lg:w-[160px] cursor-pointer">
                ...
                <div className="bg-primary flex justify-center items-center h-9 lg:h-[50px] w-[110px] lg:w-[160px] cursor-pointer">
